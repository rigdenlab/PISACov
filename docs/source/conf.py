...
html_context = {
    ...
    'github_url': 'https://github.com/rigdenlab/PISACov.git',
}
...
html_title = project + ' v{0}'.format(version)
...
# of the sidebar.
html_logo = '_static/logo_pisacov.svg'

# The name of an image file (relative to this directory) to use as a favicon of
# the docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '_static/logo_pisacov_icon.ico'
...
#man_pages = [(master_doc, 'pisacov', u'PISACov Documentation', [author], 1)]
...
#    'pyjob': ('https://pyjob.readthedocs.io', None),
    ...
    'crops': ('https://crops.readthedocs.io', None),
    'conkit': ('https://conkit.readthedocs.io', None)
}
